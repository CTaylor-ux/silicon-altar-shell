...
export const STUB_INDEX: StubRow[] = [
  ...
  },
  {
    ...
    answer:
      'Mendez et al. (2013) place the A00 Y-chromosome haplogroup at a time-to-most-recent-common-ancestor of 338,000 years, 95% CI 237,000–581,000.',
    scopeNote:
      'The estimate is disputed and the corpus records the dispute: Elhaik gives 208,300 (CI 163,900–260,200); Krahn, A00\'s own discoverer, is nearer 200,000. The entry is Tier A on the paper, not on the settlement of the question.',
    targets: [
  ...
  },
  {
    ...
    answer:
      'The Sixth International Conference of American States, Havana, 16 January – 20 February 1928. Twenty-one nations; Coolidge opened, Hughes led the U.S. delegation. Drew Ali\'s physical presence is verified by a Brill academic handbook and the S.S. Northland shipping record of 25 January.',
    targets: [
  ...
  },
  {
    ...
    answer:
      'The Dawes Act of 1887 took 86 million acres. The corpus argues the Act is only half the weapon — the Dawes Rolls (1898–1914) are the other half, a classification engine deciding blood quantum and assigning identity.',
    scopeNote:
  ...
  },
  {
    ...
    answer:
      'Two entries, 300 million years apart. The Alleghanian Orogeny welded Laurentia and Gondwana around 300 Ma — the North Carolina Appalachians and the Moroccan Anti-Atlas are the same formation. Froth flotation, developed 1944–49 at NC State\'s Minerals Research Lab, is what made Spruce Pine quartz purifiable.',
    scopeNote:
